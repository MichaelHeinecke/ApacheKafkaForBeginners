package com.apachekafkaforbeginners.streamfiltertweets;
...
public class StreamsFilterTweets {
    ...
    public static void main(String[] args) {
        ...
        KStream<String, String> filteredStream = inputTopic
                .filter((k, jsonTweet) -> extractUserFollowersInTweet(jsonTweet) > 10000); // filter for tweets of
        // users with more than 10000 followers
